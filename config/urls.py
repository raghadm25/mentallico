...
urlpatterns = [
    ...
    # Community feed (posts, likes, saves, comments)
    path(API_V1 + "community/", include("apps.community.urls")),

    # Personal tracking: mood calendar, journal entries, habits
    path(API_V1 + "wellness/", include("apps.wellness.urls")),
]
