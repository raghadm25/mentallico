...
# ---------------------------------------------------------------------------
# Hugging Face AI integration (apps.chat.ai_client)
# ---------------------------------------------------------------------------
HF_SPACE_BASE_URL = env(
    "HF_SPACE_BASE_URL", default="https://ziad9022-mentallico-api-v2.hf.space"
)
HF_API_TOKEN = env("HF_API_TOKEN", default="")
HF_API_TIMEOUT_SECONDS = env.int("HF_API_TIMEOUT_SECONDS", default=30)
CELERY_TIMEZONE = TIME_ZONE

# ---------------------------------------------------------------------------
# Google Sign-In (apps.users.views.GoogleAuthView)
# ---------------------------------------------------------------------------
# The OAuth 2.0 Client ID from Google Cloud Console (APIs & Services ->
# Credentials -> Create Credentials -> OAuth client ID -> Web application).
# Add http://localhost:5173 as an Authorized JavaScript origin. Safe to leave
# blank in development — GoogleAuthView returns a clear 503 until it's set.
GOOGLE_OAUTH_CLIENT_ID = env("GOOGLE_OAUTH_CLIENT_ID", default="")

# ---------------------------------------------------------------------------
# Facebook Login (apps.users.views.FacebookAuthView)
# ---------------------------------------------------------------------------
# From developers.facebook.com -> My Apps -> Create App -> Consumer ->
# Settings -> Basic. FACEBOOK_APP_SECRET must stay server-side only — never
# expose it to the frontend. Safe to leave blank in development —
# FacebookAuthView returns a clear 503 until both are set.
