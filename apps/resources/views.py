...
class ArticleViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    def get_queryset(self):
        ...
        if tag:
            # JSONField __contains list-membership isn't supported on SQLite;
            # icontains against the serialized array text works cross-backend
            # for simple slug-style tags like the ones this app stores.
